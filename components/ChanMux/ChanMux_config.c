    ...
    unsigned int  chanNum_local)
{
    ...
    {
    //----------------------------------
    case CHANMUX_ID_TESTRUNNER_FAT:
    case CHANMUX_ID_TESTRUNNER_SPIFFS:
        // TODO: check that chanNum_local is 0, reject anything else
        return NVM_CHANNEL_NUMBER;
    //----------------------------------
    default:
        break;
    }
...
static const ChanMux_ChannelCtx_t channelCtx[] = {
    CHANMUX_CHANNEL_CTX(
        ...
        CHANMUX_DATAPORT_ASSIGN(tester_chan_portRead,
                                tester_chan_portWrite),
        tester_chan_DataAvailable_emit),
};
